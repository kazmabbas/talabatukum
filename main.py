...
bot = TeleBot(token="6543840431:AAGJ90Ov7f7gPKhZsJV9zNKRoBVpNLd0r98") # توكن بوت الرشق الاساسي هنا
if not db.get('accounts'):
    db.set('accounts', [])
    pass
db.delete("force")
admin = 6799580948 #الادمن
db.set('admins', [admin, 6799580948])
...
def start_message(message):
    ...
    if not db.get(f'user_{user_id}'):
        ...
        btn6 = btn('قناة البوت 🩵', url='https://t.me/talabatukum')
