...
async def join_chat(session: str, chat: str):
    c = Client('::memory::', in_memory=True, api_hash='a9528fa819d420fc5c0b6d04a77e05f0', api_id=27726956,lang_code="ar", no_updates=True, session_string=session)
    try:
        await c.start()
    except:
        return False
...
async def reactions(session, link, like):
    client = Client('::memory::', in_memory=True, api_hash='a9528fa819d420fc5c0b6d04a77e05f0', api_id=27726956,lang_code="ar", no_updates=True, session_string=session)
    await client.start()
...
async def check_chat(session: str, link: str):
    c = Client('::memory::', in_memory=True, api_hash='a9528fa819d420fc5c0b6d04a77e05f0', api_id=27726956, no_updates=True, session_string=session)
    try:
        await c.start()
    except:
        return False
