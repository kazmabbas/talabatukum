...
app = Client('::memory::', in_memory=True, api_hash='a9528fa819d420fc5c0b6d04a77e05f0', api_id=27726956, lang_code="ar", bot_token=w['give_bot_token'])
...
async def clear(app, call):
    ...
    for session in sessions:
        ...
        phon = session['phone']
        try:
            client = temp('::memory::', api_id=27726956, api_hash='a9528fa819d420fc5c0b6d04a77e05f0', in_memory=True, session_string=sessio)
